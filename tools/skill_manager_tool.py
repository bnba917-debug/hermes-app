...
# All skills live under ``<HERMES_HOME>/skills/`` (profile- and scope-aware).
HERMES_HOME = get_hermes_home()


def _skills_dir() -> Path:
    """Resolve skills root at call time (supports per-user HERMES_HOME override)."""
    return get_hermes_home() / "skills"


# Back-compat alias — prefer ``_skills_dir()`` in new code.
