...
# App Gateway: CLI-like tools without host shell or browser automation.
_APP_GATEWAY_TOOLS = [
    t
...
TOOLSETS = {
    ...
    "hermes-app-gateway": {
        "description": (
            "Mobile App Gateway — near-CLI tools for multi-tenant apps: web, files, "
            "vision, skills, memory, code, delegate, cron, messaging; no terminal, "
            "browser, or computer_use"
        ),
        "tools": list(_APP_GATEWAY_TOOLS),
        "includes": []
    },
